...
/* ============ WHY TABS ============ */
const whyData = [
  { num:'01. Performance', title:'Sites that actually load fast.', desc:'We optimize every build for Google Core Web Vitals so your site is quick for visitors and ranks better in search results.', bullets:['Sub-2s load times','Compressed images and fonts','Minimal JS footprint','Caching ready at launch'] },
  { num:'02. Design', title:'Details that make a difference.', desc:'Hover each tile to see some of the effects we build into client sites. These are things we include by default, not as add-ons.', bullets:['Gradient overlays','Reveal animations','Glowing borders','Magnetic cursor effects'] },
  { num:'03. Fast Delivery', title:'From call to live in 3 to 7 days.', desc:'We follow a tight, proven workflow and keep you in the loop at every step. You will always know where things stand.', bullets:['Day 1 kickoff call','Figma mockups within 48 hours','Regular progress updates','Launch checklist included'] },
  { num:'04. 100% Custom', title:'Built for your business specifically.', desc:'Every design starts from scratch around your brand. We do not reuse templates or recycle layouts from previous projects.', bullets:['Original Figma design','Brand-matched typography','Unique layout per project','Nothing off-the-shelf'] },
  { num:'05. You Own It', title:'Everything gets handed off to you.', desc:'When the project is done, you get the domain, hosting control, and full source code. There is nothing keeping you tied to us after launch.', bullets:['Full source code delivery','Hosting in your account','Domain registered in your name','No monthly fees to stay live'] },
  { num:'06. Local Studio', title:'Based in Texas, available everywhere.', desc:"We are a small studio in Pearland, TX. You talk directly to the person building your site, not a project manager or support queue.", bullets:['Central timezone availability','Video calls on your schedule','Direct access to your builder','US-based, no outsourcing'] }
];
